...
<script>
const $=id=>document.getElementById(id);let rows=[],branches={},selected=new Set(),amounts={};const hasDesktopApi=()=>Boolean(window.pywebview&&window.pywebview.api&&typeof window.pywebview.api.save_order_csv==="function");
