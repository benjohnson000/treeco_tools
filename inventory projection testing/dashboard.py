...
<section class="panel"><h2 style="margin-top:0;font-size:18px">Import Spruce reports</h2><div class="grid import"><label>Stock Status CSV<input id="stock-file" type="file" accept=".csv"></label><label>12-month Usage CSV<input id="usage-file" type="file" accept=".csv"></label><div><button id="import">Process and save reports</button><button id="open-data-folder" class="secondary" style="margin-left:8px">Open data folder</button><button id="clear-database" class="secondary" style="margin:8px 0 0">Clear imported data</button></div></div><div class="actions" style="margin-top:12px"><label><input id="single-branch" class="check" type="checkbox"> Single-branch report format</label><label style="min-width:260px">Single-report branch<select id="import-branch" style="height:auto;margin-top:4px"></select></label></div><div class="hint" style="margin-top:8px">Imported data is used only for the current application session.</div><div id="import-status"></div></section>
