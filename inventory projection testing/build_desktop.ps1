if (Get-Process -Name SpruceInventoryReorder -ErrorAction SilentlyContinue) {
...
& python -m PyInstaller --clean --noconfirm --onefile --windowed --icon=icon.ico --name SpruceInventoryReorder desktop_app.py
if ($LASTEXITCODE -ne 0) {
